    ...
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-teal-50 to-green-50 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-gradient-to-br from-white/20 to-white/10 rounded-2xl shadow-2xl p-6 sm:p-8 backdrop-blur-xl border border-white/30 relative z-10">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-green-700/70 text-xs sm:text-sm mt-1 sm:mt-2">Your memory companion</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-gradient-to-r from-green-600 to-teal-600 text-white font-bold rounded-xl hover:from-green-700 hover:to-teal-700 disabled:opacity-50 transition-all duration-200 shadow-lg hover:shadow-xl hover:shadow-green-500/30 border border-green-400/30 text-sm sm:text-base"
          >
