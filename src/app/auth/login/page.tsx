    ...
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-gradient-to-br from-white/10 to-white/5 rounded-2xl shadow-2xl p-8 backdrop-blur-xl border border-white/20 relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-white/60 text-sm mt-2">Your intelligent memory assistant</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-bold rounded-xl hover:from-purple-700 hover:to-blue-700 disabled:opacity-50 transition-all duration-200 shadow-lg hover:shadow-xl hover:shadow-purple-500/30 border border-purple-400/30"
          >
        ...
        <p className="text-center text-white/70 mt-8">
          ...
          <Link href="/auth/signup" className="text-purple-300 hover:text-purple-200 font-bold transition-colors">
            Sign Up
          </Link>
        </p>
      </div>
