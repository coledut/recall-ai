    ...
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-teal-50 to-green-50 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-gradient-to-br from-white/20 to-white/10 rounded-2xl shadow-2xl p-8 backdrop-blur-xl border border-white/30 relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-green-700/70 text-sm mt-2">Create your memory companion</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <label className="text-sm font-semibold text-green-700">Full Name</label>
            </div>
            <input
              type="text"
              value={fullName}
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="w-6 h-6 bg-gradient-to-br from-red-400 to-red-500 rounded-full flex items-center justify-center flex-shrink-0">
                <svg className="w-3.5 h-3.5 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-gradient-to-r from-green-600 to-teal-600 text-white font-bold rounded-xl hover:from-green-700 hover:to-teal-700 disabled:opacity-50 transition-all duration-200 shadow-lg hover:shadow-xl hover:shadow-green-500/30 border border-green-400/30 mt-6"
          >
