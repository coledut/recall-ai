      ...
      {isOpen && (
        <div className="md:hidden fixed bottom-16 left-0 right-0 bg-white shadow-lg z-50 max-h-96 overflow-y-auto">
          <div className="p-3 space-y-2">
            {links.map((link) => (
              <Link key={link.href} href={link.href as any} className="block py-3 px-4 rounded-lg hover:bg-gray-100 active:bg-gray-200 transition-all text-sm font-medium" onClick={() => setIsOpen(false)}>
